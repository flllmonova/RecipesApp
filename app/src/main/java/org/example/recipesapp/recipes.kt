...
object STUB {
    ...
    private val burgerRecipes = listOf(
        Recipe(
            ...
            ingredients = listOf(
                ...
                Ingredient("1", "ст. ложки", "Майонез"),
                Ingredient("1", "ст. ложки", "Кетчуп"),
            ...
            imageUrl = "burger-hamburger.webp"
        ),
        Recipe(
            id = 1,
            title = "Чизбургер",
            ...
            imageUrl = "burger-cheeseburger.webp"
        ),
        Recipe(
            id = 2,
            ...
            imageUrl = "burger-mushrooms.webp"
        ),
        Recipe(
            id = 3,
        ...
        Recipe(
            ...
            ingredients = listOf(
                ...
                Ingredient("1", "ст. ложки", "Томатный соус"),
                Ingredient("1", "ст. ложки", "Горчица"),
        ...
        Recipe(
            ...
            ingredients = listOf(
                ...
                Ingredient("1", "ст. ложки", "Майонез"),
                Ingredient("1", "ст. ложки", "Кетчуп"),
                Ingredient("1", "ч. ложки", "Соус табаско"),
                Ingredient("1", "г", "Соль"),
                Ingredient("0.5", "г", "Перец черный молотый")
            ),
            method = listOf(
    ...
    fun getRecipesByIds(recipesIds: Set<Int>): List<Recipe> {
        return recipesIds.mapNotNull { recipeId ->
